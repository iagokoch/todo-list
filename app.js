...
taskForm.addEventListener("submit", function (event) {
    ...
    if (taskText !== "") {
        ...
        checkbox_1.classList.add("checkbox");
        checkbox_1.type = "checkbox";
        checkbox_1.addEventListener("change", function () {
            if (checkbox_1.checked) {
                taskItem_1.style.textDecoration = "line-through";
            }
            else {
                taskItem_1.style.textDecoration = "none";
            }
        });
        ...
        deleteButton.addEventListener("click", function () {
            taskList.removeChild(taskItem_1);
        });
        //adiciona o checkbox, o span e o botão de remover ao li
        taskItem_1.appendChild(checkbox_1);
        taskItem_1.appendChild(span);
